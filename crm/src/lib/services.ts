...
export const SERVICES = [
  ...
  { key: "support", label: "Поддержка сайта" },
  ...
  { key: "security", label: "Аудит безопасности сайта" },
  { key: "messenger", label: "Разработка мессенджеров" },
  { key: "infrastructure", label: "Проектирование ИТ-инфраструктуры" },
  { key: "migration", label: "Миграция и модернизация" },
  { key: "os", label: "Внедрение операционных систем" },
  { key: "itOutsourcing", label: "ИТ-аутсорсинг" },
  { key: "infosecAudit", label: "Аудит информационной безопасности" },
  { key: "infosecTools", label: "Внедрение средств защиты" },
  { key: "infosecConsulting", label: "Консалтинг по ИБ и 152-ФЗ" },
  { key: "infosecMonitoring", label: "Мониторинг ИБ и реагирование" },
  { key: "collaboration", label: "Корпоративные коммуникации" },
  { key: "businessSystems", label: "Внедрение бизнес-систем" },
  { key: "businessSystemsCustom", label: "Доработка бизнес-систем" },
  { key: "industrial", label: "Интеграция с оборудованием" },
] as const;
